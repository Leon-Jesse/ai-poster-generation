...
func newTransaction(db *gorm.DB, opts ...gen.DOOption) transaction {
	...
	_transaction.Amount = field.NewInt64(tableName, "amount")
	_transaction.ReferenceID = field.NewInt64(tableName, "reference_id")
...
type transaction struct {
	...
	Type        field.String // recharge, consume
	Amount      field.Int64  // Credit Change Amount (+/-)
	ReferenceID field.Int64  // Related ID (Order ID or Poster ID)
...
func (t *transaction) updateTableName(table string) *transaction {
	...
	t.ReferenceID = field.NewInt64(table, "reference_id")
