...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.Credits = field.NewInt64(tableName, "credits")
	...
	_order.ExpireAt = field.NewTime(tableName, "expire_at")
...
type order struct {
	...
	OrderID       field.String // Business Order ID
	UserID        field.Int64  // FK -> user.id
	Amount        field.Int64  // Payment Amount (CNY Cents)
	Credits       field.Int64  // Credits to Add
	PaymentMethod field.String // alipay, wechat
	PayURL        field.String // 支付链接
	ProductInfo   field.String // 下单时商品信息
	Status        field.String // Status: pending, paid, cancelled
	CreatedAt     field.Time
	UpdatedAt     field.Time
	ExpireAt      field.Time // 订单过期时间
	PaidAt        field.Time // 支付时间
...
func (o *order) updateTableName(table string) *order {
	...
	o.ExpireAt = field.NewTime(table, "expire_at")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["expire_at"] = o.ExpireAt
