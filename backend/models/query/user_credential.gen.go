...
func newUserCredential(db *gorm.DB, opts ...gen.DOOption) userCredential {
	...
	_userCredential.userCredentialDo.UseModel(&models.UserCredential{})
	...
	_userCredential.UserID = field.NewInt64(tableName, "user_id")
...
type userCredential struct {
	...
	PasswordHash field.String // Encrypted Password
...
type IUserCredentialDo interface {
	...
	Create(values ...*models.UserCredential) error
	CreateInBatches(values []*models.UserCredential, batchSize int) error
	Save(values ...*models.UserCredential) error
	First() (*models.UserCredential, error)
	Take() (*models.UserCredential, error)
	Last() (*models.UserCredential, error)
	Find() ([]*models.UserCredential, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.UserCredential, err error)
	FindInBatches(result *[]*models.UserCredential, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.UserCredential) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.UserCredential, error)
	FirstOrCreate() (*models.UserCredential, error)
	FindByPage(offset int, limit int) (result []*models.UserCredential, count int64, err error)
...
func (u userCredentialDo) Create(values ...*models.UserCredential) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userCredentialDo) CreateInBatches(values []*models.UserCredential, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userCredentialDo) Save(values ...*models.UserCredential) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userCredentialDo) First() (*models.UserCredential, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.UserCredential), nil
	}
}

func (u userCredentialDo) Take() (*models.UserCredential, error) {
...
func (u userCredentialDo) Last() (*models.UserCredential, error) {
...
func (u userCredentialDo) Find() ([]*models.UserCredential, error) {
	result, err := u.DO.Find()
	return result.([]*models.UserCredential), err
}

func (u userCredentialDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.UserCredential, err error) {
	buf := make([]*models.UserCredential, 0, batchSize)
...
func (u userCredentialDo) FindInBatches(result *[]*models.UserCredential, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userCredentialDo) FirstOrInit() (*models.UserCredential, error) {
...
func (u userCredentialDo) FirstOrCreate() (*models.UserCredential, error) {
...
func (u userCredentialDo) FindByPage(offset int, limit int) (result []*models.UserCredential, count int64, err error) {
...
func (u userCredentialDo) Delete(models ...*models.UserCredential) (result gen.ResultInfo, err error) {
